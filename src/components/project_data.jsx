...
const Projects = (props) => {
  const content = props.projects.map((project) =>
    ...
    <br></br>
    <a href={`${project.anchor}`} id={`project${project.id}`}><img src={require(`../assets/${project.image}.jpg`)} className="img-fluid proj-img" alt={project.title} ></img></a>
    <br></br>
    <a href={`${project.gitLink}`} target="_blank" rel="noopener noreferrer" className="github-link">
    <GITHUB></GITHUB>
     
       {/* <img src={require("../assets/github.png")} alt="Github link" className="github-link-img"></img>  */}
